System.register(["tslib", "aurelia-pal", "aurelia-templating", "aurelia-templating-resources", "aurelia-dependency-injection", "oribella", "./optional-parent", "./utils", "./auto-scroll"], function (exports_1, context_1) {
    ...
    return {
        setters: [
            ...
            function (optional_parent_1_1) {
                optional_parent_1 = optional_parent_1_1;
            },
            function (utils_1_1) {
                utils_1 = utils_1_1;
            },
            function (auto_scroll_1_1) {
                auto_scroll_1 = auto_scroll_1_1;
            }
        ],
        execute: function () {
            exports_1("SORTABLE", SORTABLE = 'oa-sortable');
            exports_1("SORTABLE_ATTR", SORTABLE_ATTR = "[" + SORTABLE + "]");
            exports_1("SORTABLE_ITEM", SORTABLE_ITEM = 'oa-sortable-item');
            ...
            Sortable = Sortable_1 = (function () {
                ...
                Sortable.prototype.isClosestSortable = function (target) {
                    var closest = utils_1.utils.closest(target, SORTABLE_ATTR, window.document);
            ...
            SortableItem = (function () {
                ...
                SortableItem.prototype.getParentSortable = function () {
                    var parent = utils_1.utils.closest(this.element.parentNode, SORTABLE_ATTR, window.document);
                    return parent && parent.au[SORTABLE].viewModel;
                };
                SortableItem.prototype.getChildSortable = function () {
                    var child = this.element.querySelector(SORTABLE_ATTR);
